...
[_RAISE] = LAYOUT_planck_grid(
    _______, KC_NUM_LOCK, KC_MS_UP,        KC_F12,            KC_F1,   KC_F2,  KC_F3,  KC_MS_BTN2, LSFT(FR_EGRV), LSFT(FR_UNDS), LSFT(FR_CCED),     KC_KP_SLASH,
    _______, KC_MS_LEFT,  KC_MS_DOWN,      KC_MS_RIGHT,       KC_F4,   KC_F5,  KC_F6,  KC_MS_BTN3, LSFT(FR_QUOT), LSFT(FR_LPRN), LSFT(FR_MINS),     KC_KP_ASTERISK,
    _______, KC_KB_MUTE,  KC_KB_VOLUME_UP, KC_KB_VOLUME_DOWN, KC_F7,   KC_F8,  KC_F9,  KC_MS_BTN1, LSFT(FR_AMPR), LSFT(FR_EACU), LSFT(FR_DQUO),     KC_KP_MINUS,
    _______, _______,     _______,         _______,           _______, KC_F10, KC_F11, _______,    LSFT(FR_AGRV), KC_KP_DOT,     KC_KP_ENTER,       KC_KP_PLUS
),
/* Lower
 * ,-----------------------------------------------------------------------------------.
 * |  €   |  &   |  =   |      |  [   |  ]   |   -  |   _  |   #  |   `  |   @  |  \   |
...
[_LOWER] = LAYOUT_planck_grid(
    ...
    _______,       FR_RPRN, FR_DLR,  FR_ASTR, ALGR(FR_QUOT), ALGR(FR_EQL),  KC_HOME, KC_PAGE_DOWN, KC_PAGE_UP,    KC_END,        LSFT(FR_UGRV), _______,
